...
- Authoritative sources only, do not use generic aggregator sites. e.g.:
...
- Procedure (Follow This Order)
    - Step 1: For each stock: price/volume, 14-period RSI, 30-day support/resistance, SEC Form 4 filings (>$100k), Capitol Trades, material news, Reddit/X sentiment
    - Step 2: For each crypto: price/volume, 14-period RSI, 30-day support/resistance, whale wallets, protocol news, Reddit sentiment
